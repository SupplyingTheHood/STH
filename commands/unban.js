...
module.exports = {
    ...
    execute: async (client, message, args) => {
        ...
        if (!message.member.hasPermission('Admin')) return message.channel.send('You are missing **BAN_MEMBERS** permission!')
        if (!message.member.hasPermission('Admin')) return message.channel.send('You are missing **BAN_MEMBERS** permission!').then(m => m.delete({ timeout: 5000 }));
